...
#spec_dir = '/dawnfs/users/shenff/dist'
#out_dir = '<FULL_PATH_TO_DESIRED_OUTPUT_DIRECTORY>'
bench_dir = '/home/fandroid/mydoc/gem5/benchspec/'

alpha_suffix = '_base.sff-alpha32'

#temp
#binary_dir = spec_dir + '/benchspec/CPU2006/401.bzip2/exe/'
#data_dir = spec_dir + '/benchspec/CPU2006/401.bzip2/data/ref/input/'
...
# REF CMDS
perlbench.cmd = [perlbench.executable] + ['lib', 'checkspam.pl', '2500', '5', '25', '11', '150', '1', '1', '1', '1']
#perlbench.cmd = [perlbench.executable] + ['lib', 'diffmail.pl', '4', '800', '10', '17', '19', '300']
#perlbench.cmd = [perlbench.executable] + ['lib', 'splitmail.pl', '1600', '12', '26', '16', '4500']
#perlbench.output = out_dir+'perlbench.out'

#401.bzip2
bzip2 = Process()
bzip2.executable = bench_dir + 'bzip2' + alpha_suffix
# TEST CMDS
#bzip2.cmd = [bzip2.executable] + ['input.program', '5']
# REF CMDS
bzip2.cmd = [bzip2.executable] + [bench_dir + 'input.source', '280']
...
#403.gcc
gcc = Process()
gcc.executable = bench_dir + 'gcc' + alpha_suffix
# TEST CMDS
#gcc.cmd = [gcc.executable] + ['cccp.i', '-o', 'cccp.s']
# REF CMDS
gcc.cmd = [gcc.executable] + [bench_dir + '166.i', '-o', bench_dir + '166.s']
